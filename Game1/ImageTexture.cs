...
namespace Game1
{
	public class ImageTexture : Image
	{
		...
		{
			spriteBatch.Draw(_texture, position ?? this.Position, this.SourceRect, this.Color * this.Alpha * (alphaBlend ?? 1.0f), 0.0f, _origin, scale ?? this.Scale, SpriteEffects.None, 0.0f);
		}
